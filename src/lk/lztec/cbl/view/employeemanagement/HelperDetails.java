 ...
 * @author Ishan
 */
public class HelperDetails extends javax.swing.JFrame {

    /**
     * Creates new form HelperDetails
     */
    public HelperDetails() throws ClassNotFoundException {
       try {
            initComponents();
            loadAllDrivers();
    ...
    private void initComponents() {
        ...
        HelperTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Helper Nic", "name", "Age", "Sex", "Address", "Phone"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HelperDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void loadAllDrivers() throws ClassNotFoundException, SQLException {
      DefaultTableModel model = (DefaultTableModel) HelperTable.getModel();
        List<MHelperDetails> list= new ControlHelperDetails().loadHelperTable();
