 ...
 * @author Ishan
 */
public class LorryDetails extends javax.swing.JFrame {

    /**
     * Creates new form LorryDetails
     */
    public LorryDetails() {
        initComponents();
        try {
            ...
            Logger.getLogger(LorryDetails.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        LorryTable.setBackground(new java.awt.Color(0, 153, 153));
        LorryTable.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        LorryTable.setForeground(new java.awt.Color(204, 204, 204));
        LorryTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Lorry Number Plate", "Driver Nic", "Helper Nic", "Date"
            }
        ) {
        ...
        LorryTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        LorryTable.setGridColor(new java.awt.Color(255, 255, 255));
        LorryTable.setOpaque(false);
        LorryTable.setSelectionBackground(new java.awt.Color(153, 255, 204));
        LorryTable.setSelectionForeground(new java.awt.Color(0, 0, 0));
        jScrollPane1.setViewportView(LorryTable);

        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 570));
        ...
        jPanel3.add(LockButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 570, 300, 50));
        ...
        jPanel3.add(DoneButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 570, 280, 50));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 580, 620));

        setSize(new java.awt.Dimension(594, 655));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LorryDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable LorryTable;
    private javax.swing.JLabel jLabel8;
    private javax.swing.JPanel jPanel3;
    private javax.swing.JScrollPane jScrollPane1;
    // End of variables declaration//GEN-END:variables

    private void loadLorry() throws ClassNotFoundException, SQLException {
         DefaultTableModel model = (DefaultTableModel) LorryTable.getModel();
        List<MNewlorry> list= new Controllorry().loadLorryTable();
        Object row[]=new Object[4];
        for (int i = 0; i < list.size(); i++) {
            row[0]=list.get(i).getNplate();
            row[1]=list.get(i).getDnic();
            row[2]=list.get(i).getHnic();
