 ...
 * @author Ishan
 */
public class OtherExpensive extends javax.swing.JFrame {

    /**
     * Creates new form OtherExpensive
     */
    public OtherExpensive() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        ExTable.setBackground(new java.awt.Color(0, 153, 153));
        ExTable.setFont(new java.awt.Font("Monospaced", 0, 14)); // NOI18N
        ExTable.setForeground(new java.awt.Color(255, 255, 255));
        ...
        ExTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ExTable.setGridColor(new java.awt.Color(255, 255, 255));
        ExTable.setOpaque(false);
        ExTable.setSelectionBackground(new java.awt.Color(153, 255, 204));
        ExTable.setSelectionForeground(new java.awt.Color(0, 0, 0));
        ...
        jPanel3.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, -1, 40));

        jLabel3.setFont(new java.awt.Font("Monospaced", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(204, 204, 204));
        jLabel3.setText("Amount");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, -1, 30));
        ...
        jPanel3.add(DescriptionTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 210, 310, -1));
        ...
        jPanel3.add(AmountTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 280, 310, -1));
        ...
        jPanel3.add(SaveNewProductButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 120, 30));
        ...
        setSize(new java.awt.Dimension(846, 656));
    ...
    private void SaveNewProductButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveNewProductButtonActionPerformed
        ...
        try {
            boolean isAdded = Controlfingmang.saveExpensive(des, amount);
            TableButton.doClick();
            if (isAdded) {
    ...
    private void TableButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TableButtonActionPerformed
       ...
       int a=model.getRowCount();
        ...
        try {
            list = new Controlfingmang().loadExpensive();
        } catch (SQLException ex) {
            Logger.getLogger(OtherExpensive.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OtherExpensive.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
